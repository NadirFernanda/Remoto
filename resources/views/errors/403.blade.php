...
<head>
    ...
    <title>Acesso negado — 24 Horas</title>
...
<body>
    <div class="err-box">
        ...
        <p class="err-msg">
            ...
            {{ $exception->getMessage() ?: 'Se acredita que isto é um erro, contacte o suporte.' }}
        </p>
        <a href="{{ url()->previous('/') }}" class="err-btn-primary">Voltar</a>
        <br>
