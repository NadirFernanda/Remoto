...
@section('content')
    <div style="text-align:center; margin-top:80px">
        ...
        <form method="get" action="/pagamento/paypal/retorno">
            <button style="background:#2563eb; color:white; font-size:1.2rem; padding:12px 32px; border:none; border-radius:8px; cursor:pointer;">Simular pagamento e retornar</button>
        </form>
