...
@php
    ...
    $isRelatorios  = in_array($adminRole, ['master', 'financeiro', 'relatorios', null]);
    $isSettings    = $isMaster;
...
<nav class="flex flex-col flex-1 py-3 overflow-y-auto">
    ...
    @if($role === 'freelancer')
        ...
        <a href="{{ route('freelancer.clients') }}"
            class="snav-item {{ request()->routeIs('freelancer.clients') ? 'snav-active' : '' }}">
        ...
        <a href="{{ route('kyc.submit') }}"
            class="snav-item {{ request()->routeIs('kyc.submit') ? 'snav-active' : '' }}" style="color:#f59e0b">
            ...
            <span class="ml-auto bg-amber-400 text-white text-xs font-bold px-1.5 py-0.5 rounded-full">!</span>
        </a>
        @endif
        ...
        <a href="{{ route('freelancer.support') }}"
            class="snav-item {{ request()->routeIs('freelancer.support') ? 'snav-active' : '' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
            Suporte
        </a>
    ...
    @elseif($role === 'admin')
        ...
        <a href="{{ route('admin.recibos.index') }}" class="snav-item {{ request()->routeIs('admin.recibos.*') ? 'snav-active' : '' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
            Recibos
        </a>
        @endif
        ...
        <a href="{{ route('admin.facturacao') }}"
            class="snav-item {{ request()->routeIs('admin.facturacao*') ? 'snav-active' : '' }}">
        ...
        <a href="{{ route('admin.support') }}"
            class="snav-item {{ request()->routeIs('admin.support') ? 'snav-active' : '' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
            Tickets de Suporte
            @php $openTickets = \App\Models\SupportTicket::where('status', 'aberto')->count(); @endphp
            @if($openTickets > 0)
                <span class="ml-auto bg-red-500 text-white text-xs font-bold px-1.5 py-0.5 rounded-full">{{ $openTickets }}</span>
            @endif
        </a>
        ...
        <a href="{{ route('admin.site-images') }}"
            class="snav-item {{ request()->routeIs('admin.site-images') ? 'snav-active' : '' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14M4 8h16M4 4h16a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1z"/></svg>
            Imagens do Site
        </a>
        ...
        <a href="{{ route('admin.team') }}"
            class="snav-item {{ request()->routeIs('admin.team') ? 'snav-active' : '' }}">
        ...
        <div class="snav-divider mt-1"></div>
        <a href="{{ route('admin.settings') }}#meu-perfil"
            class="snav-item {{ request()->routeIs('admin.settings') ? 'snav-active' : '' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
            Meu Perfil
        </a>
    ...
    @elseif(in_array($role, ['cliente', 'client']))
        ...
        <a href="{{ route('freelancers.index') }}"
            ...
            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-4.35-4.35m0 0A7.5 7.5 0 104.5 4.5a7.5 7.5 0 0012.15 12.15z"/></svg>
            Buscar Freelancers
        </a>
        ...
        <a href="{{ route('client.support') }}"
            class="snav-item {{ request()->routeIs('client.support') ? 'snav-active' : '' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
            Suporte
        </a>
