...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-5 freelancer-profile-content">
    ...
    {{-- Voltar --}}
    <a href="{{ route('freelancers.index') }}" class="dash-back-link inline-flex items-center gap-1.5 text-sm font-semibold freelancer-profile-back">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm freelancer-profile-card">
        ...
        @else
            <div class="platform-cover h-24 sm:h-32 freelancer-profile-cover relative">
