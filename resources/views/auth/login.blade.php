        ...
        <form method="POST" action="/login" novalidate id="login-form">
            ...
            <div class="lf-group">
                ...
                <input type="password" name="password" id="lf-pw"
                       ...
                       required>
                <button type="button" class="lf-eye" onclick="togglePw()" aria-label="Mostrar senha" aria-pressed="false">
                    <svg id="eye-visible" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="display:none;">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                    </svg>
                    <svg id="eye-hidden" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
function togglePw() {
    ...
    var visibleIcon = document.getElementById('eye-visible');
    var hiddenIcon = document.getElementById('eye-hidden');
    var button = visibleIcon.closest('button');
    var isVisible = inp.type === 'text';

    inp.type = isVisible ? 'password' : 'text';
    visibleIcon.style.display = isVisible ? 'none' : 'block';
    hiddenIcon.style.display = isVisible ? 'block' : 'none';
