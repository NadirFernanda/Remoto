...
{{-- Wrapper com imagem de fundo em toda a página --}}
<div style="
    min-height: calc(100vh - 70px);
    background-image: linear-gradient(135deg, rgba(0,86,210,.82) 0%, rgba(10,18,40,.93) 100%),
                      url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1600&h=900&fit=crop&auto=format&q=80');
...
">
    ...
    <a href="/" style="display:inline-block;margin-bottom:1.5rem;">
        <img src="{{ asset('img/logo.png') }}" alt="24 Horas"
             style="height:52px;object-fit:contain;filter:drop-shadow(0 0 16px rgba(0,186,255,.6));">
    </a>

    {{-- Título --}}
    <div style="text-align:center;margin-bottom:1.75rem;">
        <h1 style="font-size:1.75rem;font-weight:800;color:#fff;margin:0 0 .35rem;">Bem-vindo de volta</h1>
        <p style="color:rgba(255,255,255,.7);font-size:.95rem;margin:0;">Aceda à sua conta 24 Horas</p>
    </div>
    ...
    <div style="width:100%;max-width:440px;">
        ...
        <div style="background:rgba(255,255,255,.97);border-radius:20px;padding:2.25rem 2rem;box-shadow:0 20px 60px rgba(0,0,0,.3);">
            <form method="POST" action="/login" novalidate onsubmit="return validateLoginForm(event)">
                ...
                <button type="submit" class="pub-btn-primary"
                        style="width:100%;padding:.85rem;font-size:1rem;margin-top:.5rem;border-radius:10px;">
                    Entrar
                </button>
            </form>
            ...
            <p style="text-align:center;margin-top:1.25rem;font-size:.875rem;color:#64748b;margin-bottom:0;">
                Não tem conta?
                <a href="/register" style="color:#0070ff;font-weight:700;text-decoration:none;">Criar conta gratuita</a>
            </p>
        </div>
    </div>
    ...
    <div style="display:flex;gap:1rem;flex-wrap:wrap;justify-content:center;margin-top:2rem;">
        ...
        <div style="background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.15);backdrop-filter:blur(8px);border-radius:14px;padding:.75rem 1.25rem;text-align:center;">
            ...
            <div style="font-size:.75rem;color:rgba(255,255,255,.65);margin-top:.15rem;">Satisfação</div>
        </div>
    </div>
    ...
    <div style="margin-top:1.5rem;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.12);border-radius:16px;padding:1rem 1.4rem;max-width:440px;width:100%;">
        ...
        <p style="color:rgba(255,255,255,.85);font-size:.85rem;line-height:1.55;margin:0 0 .6rem;font-style:italic;">
