    ...
    <div class="pub-container--sm" style="width:100%;padding-top:2rem;padding-bottom:3rem;">
        <div class="pub-auth-card">
            ...
            <div style="text-align:center;margin-bottom:2rem;">
                ...
                <h1 class="pub-auth-title">Nova senha</h1>
                <p class="pub-auth-sub">Defina a sua nova senha de acesso.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <button type="submit" class="pub-btn-primary" style="width:100%;padding:.75rem;font-size:1rem;margin-top:.5rem;">Redefinir senha</button>
            </form>
