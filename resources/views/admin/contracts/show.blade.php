    ...
    <div class="rounded-2xl border border-white/10 bg-slate-900/70 p-6 shadow-sm">
        <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <dd>
                    <span class="platform-badge inline-flex text-sm font-bold @if($contract->status=='ativo') bg-emerald-500/15 text-emerald-300 border border-emerald-400/20 @elseif($contract->status=='pendente') bg-amber-500/15 text-amber-300 border border-amber-400/20 @else bg-slate-700 text-slate-200 border border-slate-600 @endif">
