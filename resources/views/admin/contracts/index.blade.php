        ...
        <table class="min-w-full text-base">
            ...
            <tbody>
                ...
                <tr class="border-b border-white/10 last:border-0 hover:bg-slate-800/60 transition">
                    ...
                    <td class="py-3 px-5">
                        <span class="platform-badge inline-flex text-xs font-bold @if($contract->status=='ativo') bg-emerald-500/15 text-emerald-300 border border-emerald-400/20 @elseif($contract->status=='pendente') bg-amber-500/15 text-amber-300 border border-amber-400/20 @else bg-slate-700 text-slate-200 border border-slate-600 @endif">
