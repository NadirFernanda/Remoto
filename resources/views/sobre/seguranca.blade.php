        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 md:p-10 mb-6 border border-[#e6f3fa] transition hover:shadow-2xl">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <div class="bg-[#111c31] rounded-2xl p-5 border border-white/10">
                    <div class="text-[#5b8cff] font-extrabold mb-2 text-lg">HTTPS / TLS</div>
                    <p class="text-[#cbd5e1] text-sm leading-relaxed m-0">Toda a comunicação entre o seu browser e os nossos servidores é cifrada com TLS 1.3.</p>
                </div>
                <div class="bg-[#111c31] rounded-2xl p-5 border border-white/10">
                    <div class="text-[#5b8cff] font-extrabold mb-2 text-lg">Autenticação 2FA</div>
                    <p class="text-[#cbd5e1] text-sm leading-relaxed m-0">Activa a verificação em dois passos para proteger o acesso à sua conta mesmo que a palavra-passe seja comprometida.</p>
                </div>
                <div class="bg-[#111c31] rounded-2xl p-5 border border-white/10">
                    <div class="text-[#5b8cff] font-extrabold mb-2 text-lg">Logs de auditoria</div>
                    <p class="text-[#cbd5e1] text-sm leading-relaxed m-0">Cada acção crítica (login, transferência, alteração de dados) fica registada com timestamp e endereço IP para rastreabilidade.</p>
                </div>
            </div>
        </div>
