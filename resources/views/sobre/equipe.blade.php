    ...
    <div class="pub-container--md" style="padding-top:0.75rem;padding-bottom:4rem;">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-6">
            <div class="bg-white rounded-3xl shadow-xl p-8 md:p-10 text-center border border-[#e6f3fa] transition hover:shadow-2xl">
                <div class="w-20 h-20 rounded-full flex items-center justify-center text-white font-black text-3xl mx-auto mb-4">N</div>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8 md:p-10 text-center border border-[#e6f3fa] transition hover:shadow-2xl">
                <div class="w-20 h-20 rounded-full flex items-center justify-center text-white font-black text-3xl mx-auto mb-4">P</div>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8 md:p-10 text-center border border-[#e6f3fa] transition hover:shadow-2xl">
                <div class="w-20 h-20 rounded-full flex items-center justify-center text-white font-black text-3xl mx-auto mb-4">C</div>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8 md:p-10 text-center border border-[#e6f3fa] transition hover:shadow-2xl">
                <div class="w-20 h-20 rounded-full flex items-center justify-center text-white font-black text-3xl mx-auto mb-4">R</div>
