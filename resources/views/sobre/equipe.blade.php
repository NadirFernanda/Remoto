...
<div class="pub-page" style="padding-top:0">
    <div class="pub-container" style="padding-top:0.75rem;padding-bottom:4rem;">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-6">
            <div class="bg-white rounded-3xl shadow-xl p-6 text-center border border-[#e6f3fa] transition hover:shadow-2xl">
                <div class="w-20 h-20 rounded-full bg-[#0055ff] flex items-center justify-center text-white font-black text-3xl mx-auto mb-4 shadow-lg shadow-blue-200">N</div>
                <div class="font-extrabold text-[#0f172a] text-lg">Nadir Fernanda</div>
                <div class="text-[#0055ff] text-xs font-bold my-1 mb-3">CEO &amp; Co-fundadora</div>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-6 text-center border border-[#e6f3fa] transition hover:shadow-2xl">
                <div class="w-20 h-20 rounded-full bg-[#0055ff] flex items-center justify-center text-white font-black text-3xl mx-auto mb-4 shadow-lg shadow-blue-200">P</div>
                <div class="font-extrabold text-[#0f172a] text-lg">Paulo Mendes</div>
                <div class="text-[#0055ff] text-xs font-bold my-1 mb-3">CTO &amp; Co-fundador</div>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-6 text-center border border-[#e6f3fa] transition hover:shadow-2xl">
                <div class="w-20 h-20 rounded-full bg-[#0055ff] flex items-center justify-center text-white font-black text-3xl mx-auto mb-4 shadow-lg shadow-blue-200">C</div>
                <div class="font-extrabold text-[#0f172a] text-lg">Catarina Lopes</div>
                <div class="text-[#0055ff] text-xs font-bold my-1 mb-3">Directora de Produto</div>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-6 text-center border border-[#e6f3fa] transition hover:shadow-2xl">
                <div class="w-20 h-20 rounded-full bg-[#0055ff] flex items-center justify-center text-white font-black text-3xl mx-auto mb-4 shadow-lg shadow-blue-200">R</div>
                <div class="font-extrabold text-[#0f172a] text-lg">Roberto Silva</div>
                <div class="text-[#0055ff] text-xs font-bold my-1 mb-3">Director de Operações</div>
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 md:p-10 text-center border border-[#e6f3fa] transition hover:shadow-2xl">
            ...
            <a href="{{ route('sobre.carreiras') }}" class="inline-block bg-[#0055ff] hover:bg-[#0047d9] text-white font-extrabold px-8 py-3 rounded-xl text-lg transition">Ver vagas abertas</a>
        </div>
