        ...
        <div class="bg-white rounded-3xl shadow-xl p-8 md:p-10 mb-6 border border-[#e6f3fa] transition hover:shadow-2xl">
            ...
            <div class="flex flex-col gap-6">
                <div class="flex gap-4 items-start">
                    <div class="w-10 h-10 min-w-[2.5rem] rounded-full text-white font-extrabold text-lg flex items-center justify-center">1</div>
                ...
                <div class="flex gap-4 items-start">
                    <div class="w-10 h-10 min-w-[2.5rem] rounded-full text-white font-extrabold text-lg flex items-center justify-center">2</div>
                ...
                <div class="flex gap-4 items-start">
                    <div class="w-10 h-10 min-w-[2.5rem] rounded-full text-white font-extrabold text-lg flex items-center justify-center">3</div>
                ...
                <div class="flex gap-4 items-start">
                    <div class="w-10 h-10 min-w-[2.5rem] rounded-full text-white font-extrabold text-lg flex items-center justify-center">4</div>
