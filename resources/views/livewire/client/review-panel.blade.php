...
<div class="reviews-page max-w-4xl mx-auto space-y-6" x-data="{ tab: 'received' }">
    ...
    {{-- ─── Gradient Header ──────────────────────────────────── --}}
    <div class="platform-page-header reviews-header rounded-2xl p-6 text-white">
    ...
    <div class="reviews-tabs flex gap-2">
        ...
        <button @click="tab = 'given'"
            :class="tab === 'given' ? 'bg-[#0055ff] text-white border-[#0055ff] shadow-sm' : 'bg-white text-gray-600 border-gray-200 hover:border-gray-300'"
            class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold border transition">
            Feitas
