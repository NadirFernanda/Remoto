<div x-data="{}">
	...
	{{-- Atalhos rápidos --}}
	   <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
		   ...
		   <a href="{{ route('client.reports') }}" class="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col items-center justify-center text-center hover:border-[#00baff]/50 transition group">
