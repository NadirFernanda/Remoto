<div x-data="{}" class="dashboard-screen">
	...
	{{-- Atalhos rápidos --}}
	   <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
		   <a href="{{ route('client.projects') }}" class="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col items-center justify-center text-center hover:border-[#0055ff]/50 transition group h-full min-h-[150px]">
			   ...
			   <span class="dashboard-shortcut-action platform-badge text-xs font-semibold mt-2">Ver todos</span>
		   </a>
		   <a href="{{ route('client.payments') }}" class="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col items-center justify-center text-center hover:border-[#0055ff]/50 transition group h-full min-h-[150px]">
			   <svg class="w-6 h-6 mb-2 text-gray-700 group-hover:text-[#0055ff] transition" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 9.776c.112-.017.227-.026.344-.026h15.812c.117 0 .232.009.344.026m-16.5 0a2.25 2.25 0 0 0-1.883 2.542l.857 6a2.25 2.25 0 0 0 2.227 1.932H19.05a2.25 2.25 0 0 0 2.227-1.932l.857-6a2.25 2.25 0 0 0-1.883-2.542m-16.5 0V6A2.25 2.25 0 0 1 6 3.75h3.879a1.5 1.5 0 0 1 1.06.44l2.122 2.12a1.5 1.5 0 0 0 1.06.44H18A2.25 2.25 0 0 1 20.25 9v.776"/></svg>
			   <span class="text-xs text-gray-700">Solicitar reembolso</span>
			   <span class="dashboard-shortcut-action platform-badge text-xs font-semibold mt-2">Solicitar</span>
		   </a>
		   <a href="{{ route('client.profile.edit') }}" class="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col items-center justify-center text-center hover:border-[#0055ff]/50 transition group h-full min-h-[150px]">
		   ...
		   <a href="{{ route('client.reports') }}" class="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col items-center justify-center text-center hover:border-[#0055ff]/50 transition group h-full min-h-[150px]">
		   ...
		   <a href="{{ route('client.finance') }}" class="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col items-center justify-center text-center hover:border-[#0055ff]/50 transition group h-full min-h-[150px]">
			   ...
			   <span class="dashboard-shortcut-action platform-badge text-xs font-semibold mt-2">Ver saldo</span>
		   </a>
		   <a href="{{ route('client.refunds') }}" class="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col items-center justify-center text-center hover:border-[#0055ff]/50 transition group h-full min-h-[150px]">
			   ...
			   <span class="dashboard-shortcut-action platform-badge text-xs font-semibold mt-2">Ver estado</span>
		   </a>
	</div>
