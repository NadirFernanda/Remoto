<div x-data="{}">
	...
	<div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
		...
		<a href="{{ route('client.payments') }}" class="bg-white rounded-2xl border border-gray-200 p-4 text-center hover:border-[#00baff]/50 transition group">
			...
			<span class="text-xs font-medium text-gray-700">Pagamentos</span>
		</a>
		...
		<a href="{{ route('client.reports') }}" class="bg-white rounded-2xl border border-gray-200 p-4 text-center hover:border-[#00baff]/50 transition group">
			...
			<span class="text-xs font-medium text-gray-700">Relatórios</span>
		</a>
	</div>
