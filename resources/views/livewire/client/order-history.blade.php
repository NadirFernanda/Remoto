    ...
    <div class="max-w-4xl mx-auto px-4 py-10">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm text-gray-400 mt-0.5">Acompanhe o status dos seus projetos</p>
            </div>
        ...
        <div class="space-y-3">
            ...
            @empty
                <div class="bg-white rounded-2xl p-12 text-center border border-dashed border-gray-200">
                    ...
                    <p class="text-gray-400 text-sm mt-1">Os seus projetos aparecerão aqui após a criação</p>
