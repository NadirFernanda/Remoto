    ...
    @if($show)
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-sm p-8 text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">O freelancer foi notificado. Pode negociar os detalhes no chat antes de ele aceitar ou recusar.</p>
                <a href="{{ route('service.chat', $service_id) }}"
                   class="btn-primary w-full text-sm py-2.5 flex items-center justify-center gap-2 mb-3 no-underline">
                ...
                <button wire:click="close" class="btn-outline w-full text-sm py-2.5">Fechar</button>
            </div>
        </div>
        @endif
