        ...
        @if($payment_method === 'bank')
            ...
            @if($step === 'reference')
                <div wire:poll.30s="checkAppyPayStatus" class="text-center py-4">
                    ...
                    <p class="text-xs text-gray-400">Assim que o pagamento for confirmado, a assinatura é activada automaticamente. Pode fechar esta página — receberá uma notificação.</p>
