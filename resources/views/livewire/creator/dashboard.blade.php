<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex gap-3">
            <a href="{{ route('social.creator', $user) }}"
               class="inline-flex items-center gap-2 text-sm font-semibold text-[#0055ff] border border-[#0055ff] px-4 py-2 rounded-xl hover:bg-[#0055ff]/5 transition">
            ...
            <a href="{{ route('loja.index') }}"
               class="inline-flex items-center gap-2 text-sm font-semibold text-white bg-[#0055ff] px-4 py-2 rounded-xl hover:bg-[#009ad6] transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <p class="text-3xl font-bold text-[#0055ff] mt-1">{{ number_format($monthlyEarnings, 0, ',', '.') }} KZS</p>
    ...
    {{-- Share links --}}
    <div class="bg-gradient-to-r from-[#00c8ff]/10 to-cyan-50 rounded-2xl p-5 flex flex-col md:flex-row items-start md:items-center gap-4">
        <div class="flex-1">
        ...
        <div class="flex gap-3 flex-wrap">
            <div class="flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-3 py-2 text-xs text-gray-600 min-w-0">
                <svg class="w-3.5 h-3.5 text-[#0055ff] flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @if(!auth()->user()->has_freelancer_profile)
                <a href="{{ route('creator.activate', ['profile' => 'freelancer']) }}"
                   class="flex items-center gap-4 p-4 border-2 border-dashed border-gray-200 rounded-xl hover:border-[#0055ff]/50 hover:bg-blue-50/20 transition">
