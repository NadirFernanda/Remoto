    ...
    <div class="relative overflow-hidden rounded-2xl p-7 sm:p-9 text-white" style="background: #0055ff;">
        ...
        <div class="relative">
            ...
            <div class="max-w-lg mt-5">
                <div class="relative">
                    <svg class="loja-search-icon absolute left-4 top-1/2 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
