<div x-data x-init="setInterval(() => $wire.$refresh(), 30000)" class="relative inline-flex">
    <a href="{{ route('chat.inbox') }}"
       ...
       onmouseover="this.style.background='rgba(0,80,255,.13)';this.style.borderColor='rgba(0,80,255,.3)'" onmouseout="this.style.background='rgba(255,255,255,.06)';this.style.borderColor='rgba(255,255,255,.08)'">
