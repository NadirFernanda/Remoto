                    ...
                    <tr wire:key="category-{{ $cat->id }}" class="border-b last:border-0 hover:bg-gray-50 transition">
                        ...
                        <td class="py-3 px-5 text-center">
                            <button wire:click="toggleActive({{ $cat->id }})"
                                class="platform-badge inline-flex items-center text-xs font-bold transition {{ $cat->active ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-500 hover:bg-gray-200' }}">
