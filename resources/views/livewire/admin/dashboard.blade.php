<div x-data="{}" class="dashboard-screen">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
        @php
            $pipeCards = [
                ...
                ['label' => 'Conversão',    'val' => $stats['conversion_rate'].'%','cls' => 'bg-[#0055ff]/10 text-[#0055ff] border-[#0055ff]/20'],
            ];
        @endphp
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-5 mb-6">
        ...
        @php
            $funnelSteps = [
                ...
                ['label' => 'Contrataram',      'val' => $funnel['hired'],      'color' => 'bg-[#0055ff]'],
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5 min-w-0">
            ...
            <div class="space-y-2">
                @foreach([
                    ...
                    ['Freelancers', $stats['users_freelancers'],  'text-[#0055ff]'],
        ...
        <div class="space-y-1">
            @forelse($recentLogs as $log)
                <div class="flex items-start gap-3 py-2 border-b border-gray-50 last:border-0">
                    <div class="w-6 h-6 rounded-full bg-[#0055ff]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <svg class="w-3 h-3 text-[#0055ff]" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        @foreach([
            ...
            <a href="{{ route($qa['route']) }}" class="bg-white rounded-2xl border border-gray-200 p-4 text-center hover:border-[#0055ff]/50 transition group">
                <svg class="w-6 h-6 mx-auto mb-2 text-gray-400 group-hover:text-[#0055ff] transition" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
