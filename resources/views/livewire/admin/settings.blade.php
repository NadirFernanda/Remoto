<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        {{-- b2. Valor mínimo de projecto --}}
        <div class="mb-4">
            <label class="block text-xs font-medium text-gray-500 mb-1">
                b2. Valor Mínimo de Projecto (Kz)
            </label>
            <input wire:model="projectMinValue" type="number" min="1" step="1" placeholder="5"
                class="w-full border border-gray-200 rounded-[10px] px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#0055ff]/30 focus:border-[#0055ff] @error('projectMinValue') border-red-400 @enderror">
            <p class="text-xs text-gray-400 mt-1">Valor mínimo que um cliente pode definir ao publicar um projecto. Reduza temporariamente para fases de teste.</p>
            @error('projectMinValue') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
        </div>
