    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6 border-l-4 border-sky-400">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 text-sm">
            ...
            <div>
                ...
                <span class="platform-badge text-xs font-bold @if($service->status === 'in_progress') bg-yellow-100 text-yellow-700 @elseif($service->status === 'delivered') bg-blue-100 text-blue-700 @elseif($service->status === 'completed') bg-green-100 text-green-700 @elseif($service->status === 'accepted') bg-sky-100 text-sky-700 @else bg-gray-100 text-gray-600 @endif">
