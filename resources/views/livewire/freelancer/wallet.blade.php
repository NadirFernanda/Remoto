    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <form wire:submit.prevent="solicitarSaque" class="space-y-4">
            <div>
                ...
                <input type="number" min="1" wire:model="valor_saque" class="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-[#0055ff]/40 focus:border-[#0055ff]">
            </div>
            ...
            <button type="submit" class="w-full bg-[#0055ff] hover:bg-[#009ad6] text-white font-bold py-3 rounded-xl transition">Solicitar saque</button>
        </form>
        @if($mensagem)
