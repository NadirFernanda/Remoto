            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div wire:key="portfolio-item-{{ $item->id }}" class="bg-white border rounded-xl overflow-hidden shadow-sm group relative">
                        ...
                        @endif
                        @if($item->media_path)
                            <img src="{{ \Illuminate\Support\Facades\Storage::disk('public')->url($item->media_path) }}" alt="{{ $item->title }}" loading="lazy" decoding="async" class="w-full h-40 object-cover">
                        @else
                ...
                <div class="space-y-2">
                    ...
                    <div wire:key="portfolio-item-{{ $item->id }}" class="bg-white border rounded-xl p-4 shadow-sm flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            @endif
                            @if($item->media_path)
                                <a href="{{ \Illuminate\Support\Facades\Storage::disk('public')->url($item->media_path) }}" target="_blank"
