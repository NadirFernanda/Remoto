<div x-data="{}" class="dashboard-screen">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        <a href="{{ route('freelancer.portfolio') }}" class="bg-white rounded-2xl border border-gray-200 p-4 text-center hover:border-[#0055ff]/50 transition group">
            ...
            <div class="mt-2">
                <span class="dashboard-shortcut-action platform-badge text-xs font-semibold">Ver todos</span>
            </div>
        </a>
        <a href="{{ route('freelancer.financial') }}" class="bg-white rounded-2xl border border-gray-200 p-4 text-center hover:border-[#0055ff]/50 transition group">
        ...
        <a href="{{ route('freelancer.profile.edit') }}" class="bg-white rounded-2xl border border-gray-200 p-4 text-center hover:border-[#0055ff]/50 transition group">
        ...
        <a href="{{ route('freelancer.projects') }}" class="bg-white rounded-2xl border border-gray-200 p-4 text-center hover:border-[#0055ff]/50 transition group">
            <svg class="w-6 h-6 mx-auto mb-2 text-gray-400 group-hover:text-[#0055ff] transition" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 7h18M3 12h18M3 17h18"/></svg>
