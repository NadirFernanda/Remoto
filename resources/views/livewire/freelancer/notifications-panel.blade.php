<div class="mb-8">
    ...
    <div class="space-y-2">
        @forelse($notifications->take(3) as $notification)
            <a href="{{ $notification->getUrl() }}" class="flex items-start gap-3 px-4 py-3 rounded-lg border border-gray-100 bg-gray-50 hover:bg-sky-50 hover:border-sky-200 transition">
