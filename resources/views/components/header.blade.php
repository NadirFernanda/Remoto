                                ...
                                <div x-show="tab==='habilidade'">
                                    ...
                                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:.625rem;">
                                        ...
                                        <a href="{{ route('freelancers.search', ['skill' => 'WordPress,Laravel,PHP,Node.js,React,HTML,CSS']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1547658719-da2b51169166?w=240&h=90&fit=crop&auto=format" alt="Web" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e293b;padding:.45rem .7rem;font-size:.75rem;font-weight:700;color:#f1f5f9;">Dev. de Websites</div>
                                        </a>
                                        <a href="{{ route('freelancers.search', ['skill' => 'Flutter,React Native,Swift,Kotlin']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=240&h=90&fit=crop&auto=format" alt="Mobile" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e293b;padding:.45rem .7rem;font-size:.75rem;font-weight:700;color:#f1f5f9;">Apps Mobile</div>
                                        </a>
                                        <a href="{{ route('freelancers.search', ['skill' => 'Edição de Vídeo,Premiere Pro,After Effects']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=240&h=90&fit=crop&auto=format" alt="Video" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e293b;padding:.45rem .7rem;font-size:.75rem;font-weight:700;color:#f1f5f9;">Edição de Vídeo</div>
                                        </a>
                                        <a href="{{ route('freelancers.search', ['skill' => 'Marketing Digital,SEO,Google Ads,Facebook Ads']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1533750516457-a7f992034fec?w=240&h=90&fit=crop&auto=format" alt="Marketing" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e293b;padding:.45rem .7rem;font-size:.75rem;font-weight:700;color:#f1f5f9;">Marketing Digital</div>
                                        </a>
                                        <a href="{{ route('freelancers.search', ['skill' => 'Redação,Copywriting,Tradução']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1455390582262-044cdead277a?w=240&h=90&fit=crop&auto=format" alt="Redacao" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                ...
                                <div x-show="tab==='localizacao'" style="display:none;">
                                    ...
                                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:.625rem;">
                                        <a href="{{ route('freelancers.search', ['location' => 'Luanda']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?w=240&h=90&fit=crop&auto=format" alt="Luanda" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                        ...
                                        <a href="{{ route('freelancers.search', ['location' => 'Benguela']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1470770841072-f978cf4d019e?w=240&h=90&fit=crop&auto=format" alt="Benguela" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                        ...
                                        <a href="{{ route('freelancers.search', ['location' => 'Huambo']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=240&h=90&fit=crop&auto=format" alt="Huambo" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                        ...
                                        <a href="{{ route('freelancers.search', ['location' => 'Lobito']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1500835556837-99ac94a94552?w=240&h=90&fit=crop&auto=format" alt="Lobito" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                        ...
                                        <a href="{{ route('freelancers.search', ['location' => 'Cabinda']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1508739773434-c26b3d09e071?w=240&h=90&fit=crop&auto=format" alt="Cabinda" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                ...
                                <div x-show="tab==='categoria'" style="display:none;">
                                    ...
                                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:.625rem;">
                                        <a href="{{ route('freelancers.index') }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=240&h=90&fit=crop&auto=format" alt="Tech" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e293b;padding:.45rem .7rem;font-size:.75rem;font-weight:700;color:#f1f5f9;">Tecnologia</div>
                                        </a>
                                        <a href="{{ route('freelancers.index') }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1542744094-3a31f272c490?w=240&h=90&fit=crop&auto=format" alt="Criativo" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e293b;padding:.45rem .7rem;font-size:.75rem;font-weight:700;color:#f1f5f9;">Criativo</div>
                                        </a>
                                        <a href="{{ route('freelancers.index') }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=240&h=90&fit=crop&auto=format" alt="Negocios" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e293b;padding:.45rem .7rem;font-size:.75rem;font-weight:700;color:#f1f5f9;">Negócios</div>
                                        </a>
                                        <a href="{{ route('freelancers.index') }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=240&h=90&fit=crop&auto=format" alt="Educacao" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e293b;padding:.45rem .7rem;font-size:.75rem;font-weight:700;color:#f1f5f9;">Educação</div>
                                        </a>
                                        <a href="{{ route('freelancers.index') }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=240&h=90&fit=crop&auto=format" alt="Juridico" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e293b;padding:.45rem .7rem;font-size:.75rem;font-weight:700;color:#f1f5f9;">Jurídico</div>
                                        </a>
                                        <a href="{{ route('freelancers.index') }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.18)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=240&h=90&fit=crop&auto=format" alt="Engenharia" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                            ...
                            <div style="flex:1;padding:1.5rem 1.125rem;min-height:380px;display:flex;flex-direction:column;">
                                ...
                                <div x-show="tab==='habilidade'">
                                    ...
                                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:.625rem;margin-bottom:.875rem;">
                                        <a href="{{ route('public.projects', ['q' => 'website']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.4)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1547658719-da2b51169166?w=240&h=90&fit=crop&auto=format" alt="Web" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e2a3a;padding:.45rem .7rem;font-size:.73rem;font-weight:700;color:#e2e8f0;">Websites</div>
                                        </a>
                                        <a href="{{ route('public.projects', ['q' => 'design']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.4)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1626785774573-4b799315345d?w=240&h=90&fit=crop&auto=format" alt="Design" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e2a3a;padding:.45rem .7rem;font-size:.73rem;font-weight:700;color:#e2e8f0;">Design Gráfico</div>
                                        </a>
                                        <a href="{{ route('public.projects', ['q' => 'marketing']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.4)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1533750516457-a7f992034fec?w=240&h=90&fit=crop&auto=format" alt="Marketing" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                ...
                                <div x-show="tab==='destaque'" style="display:none;">
                                    ...
                                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:.625rem;margin-bottom:.875rem;">
                                        <a href="{{ route('freelancer.available-projects') }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.4)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=240&h=90&fit=crop&auto=format" alt="Apps" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e2a3a;padding:.45rem .7rem;font-size:.73rem;font-weight:700;color:#e2e8f0;">Dev. de Apps</div>
                                        </a>
                                        <a href="{{ route('freelancer.available-projects') }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.4)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=240&h=90&fit=crop&auto=format" alt="Data" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e2a3a;padding:.45rem .7rem;font-size:.73rem;font-weight:700;color:#e2e8f0;">Entrada de Dados</div>
                                        </a>
                                        <a href="{{ route('freelancer.available-projects') }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.4)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=240&h=90&fit=crop&auto=format" alt="Local" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                ...
                                <div x-show="tab==='concursos'" style="display:none;">
                                    ...
                                    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:.625rem;margin-bottom:.875rem;">
                                        <a href="{{ route('public.projects', ['q' => 'vídeo']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.4)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=240&h=90&fit=crop&auto=format" alt="Video" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e2a3a;padding:.45rem .7rem;font-size:.73rem;font-weight:700;color:#e2e8f0;">Edição de Vídeo</div>
                                        </a>
                                        <a href="{{ route('public.projects', ['q' => 'conteúdo']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.4)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1455390582262-044cdead277a?w=240&h=90&fit=crop&auto=format" alt="Escrita" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                            <div style="background:#1e2a3a;padding:.45rem .7rem;font-size:.73rem;font-weight:700;color:#e2e8f0;">Escrita & Conteúdo</div>
                                        </a>
                                        <a href="{{ route('public.projects', ['q' => 'tecnologia']) }}" style="border-radius:.875rem;overflow:hidden;text-decoration:none;display:block;transition:transform .18s,box-shadow .18s;" onmouseover="this.style.transform='translateY(-4px)';this.style.boxShadow='0 10px 30px rgba(0,0,0,.4)'" onmouseout="this.style.transform='';this.style.boxShadow=''">
                                            <div style="height:82px;overflow:hidden;position:relative;"><img src="https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=240&h=90&fit=crop&auto=format" alt="Tech" style="width:100%;height:100%;object-fit:cover;display:block;"><div style="position:absolute;inset:0;background:#0b1220;"></div></div>
                                ...
                                <div style="display:flex;flex-wrap:wrap;gap:.35rem .875rem;margin-top:.5rem;">
                                    <a href="{{ route('public.projects', ['q' => 'desenvolvimento']) }}" style="font-size:.73rem;color:#64748b;text-decoration:none;" onmouseover="this.style.color='#0033cc'" onmouseout="this.style.color='#64748b'">Desenvolvimento de Software</a>
                                    <a href="{{ route('public.projects', ['q' => 'conteúdo']) }}" style="font-size:.73rem;color:#64748b;text-decoration:none;" onmouseover="this.style.color='#0033cc'" onmouseout="this.style.color='#64748b'">Escrita & Conteúdo</a>
                                    <a href="{{ route('public.projects', ['q' => 'vídeo']) }}" style="font-size:.73rem;color:#64748b;text-decoration:none;" onmouseover="this.style.color='#0033cc'" onmouseout="this.style.color='#64748b'">Edição de Vídeo</a>
                                    <a href="{{ route('public.projects', ['q' => 'seo']) }}" style="font-size:.73rem;color:#64748b;text-decoration:none;" onmouseover="this.style.color='#0033cc'" onmouseout="this.style.color='#64748b'">SEO & SEM</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="header-actions">
            ...
            @else
                ...
                <div style="display:flex;align-items:center;gap:.625rem;">
                    ...
                    @include('partials.header-chat-badge')
                    @include('partials.header-notification-bell')
                    @endif
                    {{-- Publicar / Admin Menu --}}
                    @if(auth()->user()->activeRole() === 'admin')
                    ...
                    <div x-data="{open:false}" class="relative">
                        <button @click="open = !open"
                                style="display:flex;align-items:center;gap:.4rem;padding:.4rem .75rem;border-radius:.6875rem;background:#ff2d55;color:#fff;font-weight:700;font-size:.78rem;border:none;cursor:pointer;white-space:nowrap;transition:background .15s;"
                    ...
                    <div x-data="{open:false, role:'{{ auth()->user()->activeRole() }}'}" class="relative">
                        <button @click="open = !open"
                                style="display:flex;align-items:center;gap:.4rem;padding:.4rem .75rem;border-radius:.6875rem;background:#0055ff;color:#fff;font-weight:700;font-size:.78rem;border:none;cursor:pointer;white-space:nowrap;transition:background .15s;"
                        ...
                        <div x-show="open" @click.outside="open = false" x-cloak
                             class="absolute right-0 mt-2 rounded-xl z-50"
                             style="width:230px;background:#141928;box-shadow:0 16px 48px rgba(0,0,0,.55);border:1px solid rgba(255,255,255,.08);padding:.625rem;">
                            <a href="{{ route('client.briefing') }}" @click="open=false; if(role!=='cliente'){$event.preventDefault();$dispatch('open-role-switch-modal',{action:'projeto'})}"
                               style="display:flex;align-items:center;gap:.75rem;padding:.65rem .875rem;border-radius:.625rem;text-decoration:none;transition:background .15s;"
                               onmouseover="this.style.background='rgba(0,80,255,.08)'" onmouseout="this.style.background='transparent'">
                                ...
                                <span>
                                    <span style="display:block;font-weight:700;color:#f1f5f9;font-size:.82rem;">Novo Projecto</span>
                            ...
                            <a href="{{ route('social.create') }}" @click="open=false; if(!['freelancer','creator'].includes(role)){$event.preventDefault();$dispatch('open-role-switch-modal',{action:'conteudo'})}"
                               ...
                               onmouseover="this.style.background='rgba(0,80,255,.08)'" onmouseout="this.style.background='transparent'">
                                ...
                                <span>
                                    <span style="display:block;font-weight:700;color:#f1f5f9;font-size:.82rem;">Publicar Conteúdo</span>
        ...
        <div class="mobile-menu-dropdown flex flex-col gap-1 bg-[#071422] border border-white/10 rounded-xl p-3 mt-2 shadow-xl">
            ...
            <div x-data="{sub:false}">
                ...
                <div x-show="sub" x-cloak class="pl-3 mt-1 flex flex-col gap-1 border-l border-white/10 ml-2">
                    ...
                    <a href="{{ route('freelancers.search', ['skill' => 'UI/UX Design,Figma,Adobe Photoshop,Adobe Illustrator']) }}" class="nav-link text-sm flex items-center gap-2">
                    ...
                    <a href="{{ route('freelancers.search', ['skill' => 'WordPress,Laravel,PHP,Node.js,React,HTML,CSS']) }}" class="nav-link text-sm flex items-center gap-2">
                    ...
                    <a href="{{ route('freelancers.search', ['skill' => 'Flutter,React Native,Swift,Kotlin']) }}" class="nav-link text-sm flex items-center gap-2">
                    ...
                    <a href="{{ route('freelancers.search', ['skill' => 'Edição de Vídeo,Premiere Pro,After Effects']) }}" class="nav-link text-sm flex items-center gap-2">
                    ...
                    <a href="{{ route('freelancers.search', ['skill' => 'Marketing Digital,SEO,Google Ads,Facebook Ads']) }}" class="nav-link text-sm flex items-center gap-2">
                    ...
                    <a href="{{ route('freelancers.search', ['skill' => 'Redação,Copywriting,Tradução']) }}" class="nav-link text-sm flex items-center gap-2">
            ...
            <div x-data="{sub:false}">
                ...
                <div x-show="sub" x-cloak class="pl-3 mt-1 flex flex-col gap-1 border-l border-white/10 ml-2">
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wider px-2 pt-1">Por habilidade</p>
                    <a href="{{ route('public.projects', ['q' => 'website']) }}" class="nav-link text-sm flex items-center gap-2">
                    ...
                    <a href="{{ route('public.projects', ['q' => 'design']) }}" class="nav-link text-sm flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0033cc" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/></svg>Design Gráfico</a>
                    <a href="{{ route('public.projects', ['q' => 'marketing']) }}" class="nav-link text-sm flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0033cc" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18 20V10M12 20V4M6 20v-6"/></svg>Marketing Digital</a>
                    ...
                    <a href="{{ route('public.projects', ['q' => 'vídeo']) }}" class="nav-link text-sm flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0033cc" stroke-width="2" viewBox="0 0 24 24"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg>Edição de Vídeo</a>
                    <a href="{{ route('public.projects', ['q' => 'conteúdo']) }}" class="nav-link text-sm flex items-center gap-2">
                    ...
                    <a href="{{ route('public.projects', ['q' => 'tecnologia']) }}" class="nav-link text-sm flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0033cc" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/></svg>Tecnologia</a>
                    ...
                    <a href="{{ route('public.projects', ['q' => 'desenvolvimento']) }}" class="nav-link text-sm flex items-center gap-2">Desenvolvimento de Software</a>
                    <a href="{{ route('public.projects', ['q' => 'conteúdo']) }}" class="nav-link text-sm flex items-center gap-2">Escrita & Conteúdo</a>
                    <a href="{{ route('public.projects', ['q' => 'vídeo']) }}" class="nav-link text-sm flex items-center gap-2">Edição de Vídeo</a>
                    <a href="{{ route('public.projects', ['q' => 'seo']) }}" class="nav-link text-sm flex items-center gap-2">SEO & SEM</a>
                </div>
            </div>
            <!-- Accordion: Soluções -->
            <div x-data="{sub:false}">
            ...
            @else
                ...
                @else
                @php $mobileRole = auth()->user()->activeRole(); @endphp
                @if($mobileRole === 'freelancer')
                <div class="flex flex-col gap-0.5">
                    <a href="{{ route('freelancer.dashboard') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0055ff" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
                        Dashboard
                    </a>
                    ...
                    <a href="{{ route('chat.inbox') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0055ff" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                        Mensagens
                    </a>
                    <a href="{{ route('reviews.panel') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0055ff" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>
                        Avaliações
                    </a>
                    ...
                    <div class="border-t border-white/10 my-1"></div>
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wider px-2 pt-1 pb-0.5">Monetização</p>
                    ...
                    <a href="{{ route('social.creators') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0055ff" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
                        Buscar Criadores
                    </a>
                    <a href="{{ route('freelancer.clients') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0055ff" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        Buscar Clientes
                    </a>
                    ...
                    <a href="{{ route('creator.subscriptions') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0055ff" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/></svg>
                        Minhas Assinaturas
                    </a>
                    @endif
                    <div class="border-t border-white/10 my-1"></div>
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wider px-2 pt-1 pb-0.5">Financeiro</p>
                    <a href="{{ route('freelancer.financial') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#10b981" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        Painel Financeiro
                    </a>
                    <div class="border-t border-white/10 my-1"></div>
                    @if((auth()->user()->kyc_status ?? 'pending') !== 'verified')
                    <a href="{{ route('kyc.submit') }}" class="nav-link flex items-center gap-2" style="color:#f59e0b">
                        <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                        Verificar Identidade
                    </a>
                    @endif
                    <a href="{{ route('freelancer.settings') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#94a3b8" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><circle cx="12" cy="12" r="3"/></svg>
                        Configurações
                    </a>
                    <a href="{{ route('freelancer.support') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#94a3b8" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                        Suporte
                    </a>
                </div>
                @elseif(in_array($mobileRole, ['cliente', 'client']))
                <div class="flex flex-col gap-0.5">
                    <a href="{{ route('client.dashboard') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0055ff" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
                        Dashboard
                    </a>
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-wider px-2 pt-1 pb-0.5">Projectos</p>
                    ...
                    <a href="{{ route('freelancers.index') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#0055ff" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-4.35-4.35m0 0A7.5 7.5 0 104.5 4.5a7.5 7.5 0 0012.15 12.15z"/></svg>
                        Buscar Freelancers
                    </a>
                    ...
                    @endif
                    <a href="{{ route('client.support') }}" class="nav-link flex items-center gap-2">
                        <svg width="14" height="14" fill="none" stroke="#94a3b8" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                        Suporte
                    </a>
                </div>
...
<div x-data="{
    ...
    <div x-show="show"
        ...
        {{-- Icon --}}
        <div style="width:56px;height:56px;border-radius:14px;background:#0b1220;border:1px solid rgba(0,80,255,.22);display:flex;align-items:center;justify-content:center;margin-bottom:1.25rem;">
        ...
        <div style="display:flex;align-items:center;justify-content:center;gap:.875rem;margin-bottom:1.375rem;padding:.8rem 1rem;background:rgba(255,255,255,.03);border-radius:.875rem;border:1px solid rgba(255,255,255,.08);">
            <div style="text-align:center;">
                <div style="font-size:.6rem;font-weight:700;color:#94a3b8;text-transform:uppercase;letter-spacing:.08em;margin-bottom:.3rem;">Modo actual</div>
                <span style="font-size:.8rem;font-weight:700;color:#f87171;background:rgba(248,113,113,.12);border:1px solid rgba(248,113,113,.25);border-radius:.45rem;padding:.18rem .6rem;">{{ $currentRoleLabel }}</span>
            </div>
        ...
        <form method="POST" action="{{ route('switch.role') }}" style="display:flex;flex-direction:column;gap:.5rem;">
            ...
            <button type="button" @click="show=false"
                    style="width:100%;padding:.6rem 1rem;border-radius:.75rem;background:transparent;color:#94a3b8;font-weight:600;font-size:.85rem;border:1px solid rgba(255,255,255,.1);cursor:pointer;transition:all .15s;"
                    onmouseover="this.style.background='rgba(255,255,255,.06)';this.style.color='#cbd5e1'" onmouseout="this.style.background='transparent';this.style.color='#94a3b8'">
                Cancelar
            </button>
        </form>
        @endif
