...
<div class="pub-container--md" style="padding-top:0.75rem;padding-bottom:4rem;">
    <div class="pub-hero" style="margin-bottom:2.5rem;">
        ...
        <h1 class="pub-hero-title">Política de Privacidade</h1>
        <p class="pub-hero-sub">Saiba como recolhemos, utilizamos e protegemos os seus dados pessoais.</p>
    ...
    <section class="rounded-3xl shadow-xl p-7 md:p-8 mb-5 border border-white/10" style="background:#0d1424;">
        <h2 class="text-xl font-semibold text-[#f1f5f9] mb-3">1. Responsável pelo tratamento</h2>
        <p>
            O responsável pelo tratamento dos seus dados pessoais é a
            <strong class="text-[#f1f5f9]">24h_Remoto</strong>,
            com sede em Luanda, Angola, contactável através de
            <a href="mailto:contacto@24horas.ao" class="text-[#5b8cff] hover:underline">
                contacto@24horas.ao
            </a>.
        </p>
    </section>
    ...
    <section class="rounded-3xl shadow-xl p-7 md:p-8 mb-5 border border-white/10" style="background:#0d1424;">
        <h2 class="text-xl font-semibold text-[#f1f5f9] mb-3">2. Dados recolhidos</h2>
    ...
    <section class="rounded-3xl shadow-xl p-7 md:p-8 mb-5 border border-white/10" style="background:#0d1424;">
        <h2 class="text-xl font-semibold text-[#f1f5f9] mb-3">3. Finalidade e base legal</h2>
        <ul class="list-disc pl-5 space-y-1">
            <li><strong class="text-[#f1f5f9]">Execução contratual</strong> — prestação dos serviços da plataforma (Art. 6.º, n.º 1, al. b) RGPD / Art. 7.º Lei 22/11).</li>
            <li><strong class="text-[#f1f5f9]">Obrigação legal</strong> — cumprimento de obrigações fiscais e KYC (Art. 6.º, n.º 1, al. c) RGPD).</li>
            <li><strong class="text-[#f1f5f9]">Consentimento</strong> — envio de comunicações de marketing e cookies analíticos (Art. 6.º, n.º 1, al. a) RGPD).</li>
            <li><strong class="text-[#f1f5f9]">Interesse legítimo</strong> — segurança da plataforma e prevenção de fraude (Art. 6.º, n.º 1, al. f) RGPD).</li>
        </ul>
    </section>

    <section class="rounded-3xl shadow-xl p-7 md:p-8 mb-5 border border-white/10" style="background:#0d1424;">
        <h2 class="text-xl font-semibold text-[#f1f5f9] mb-3">4. Cookies</h2>
        <p class="mb-2">Utilizamos dois tipos de cookies:</p>
        <ul class="list-disc pl-5 space-y-1">
            <li><strong class="text-[#f1f5f9]">Essenciais</strong> — necessários para autenticação e segurança da sessão. Não podem ser desactivados.</li>
            <li><strong class="text-[#f1f5f9]">Analíticos</strong> — recolhem dados de navegação de forma anónima para melhorar a plataforma. Apenas activados com o seu consentimento.</li>
        </ul>
        <p class="mt-2">Pode alterar as suas preferências a qualquer momento clicando em «Apenas essenciais» no banner de cookies.</p>
    </section>

    <section class="rounded-3xl shadow-xl p-7 md:p-8 mb-5 border border-white/10" style="background:#0d1424;">
        <h2 class="text-xl font-semibold text-[#f1f5f9] mb-3">5. Partilha de dados</h2>
        <p>
    ...
    <section class="rounded-3xl shadow-xl p-7 md:p-8 mb-5 border border-white/10" style="background:#0d1424;">
        <h2 class="text-xl font-semibold text-[#f1f5f9] mb-3">6. Transferências internacionais</h2>
        <p>
    ...
    <section class="rounded-3xl shadow-xl p-7 md:p-8 mb-5 border border-white/10" style="background:#0d1424;">
        <h2 class="text-xl font-semibold text-[#f1f5f9] mb-3">7. Os seus direitos</h2>
    ...
    <section class="rounded-3xl shadow-xl p-7 md:p-8 mb-5 border border-white/10" style="background:#0d1424;">
        <h2 class="text-xl font-semibold text-[#f1f5f9] mb-3">8. Conservação dos dados</h2>
        <p>
    ...
    <section class="rounded-3xl shadow-xl p-7 md:p-8 border border-white/10" style="background:#111c31;">
        <h2 class="text-xl font-semibold text-[#f1f5f9] mb-3">9. Actualizações</h2>
        <p>
