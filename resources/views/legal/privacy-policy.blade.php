...
<div class="max-w-3xl mx-auto px-4 py-16 text-gray-300">
    ...
    <section class="mb-8">
        <h2 class="text-xl font-semibold text-white mb-3">1. Responsável pelo tratamento</h2>
        <p>
    ...
    <section class="mb-8">
        <h2 class="text-xl font-semibold text-white mb-3">2. Dados recolhidos</h2>
    ...
    <section class="mb-8">
        <h2 class="text-xl font-semibold text-white mb-3">3. Finalidade e base legal</h2>
        <ul class="list-disc pl-5 space-y-1">
            <li><strong class="text-white">Execução contratual</strong> — prestação dos serviços da plataforma (Art. 6.º, n.º 1, al. b) RGPD / Art. 7.º Lei 22/11).</li>
            <li><strong class="text-white">Obrigação legal</strong> — cumprimento de obrigações fiscais e KYC (Art. 6.º, n.º 1, al. c) RGPD).</li>
            <li><strong class="text-white">Consentimento</strong> — envio de comunicações de marketing e cookies analíticos (Art. 6.º, n.º 1, al. a) RGPD).</li>
            <li><strong class="text-white">Interesse legítimo</strong> — segurança da plataforma e prevenção de fraude (Art. 6.º, n.º 1, al. f) RGPD).</li>
        </ul>
    </section>

    <section class="mb-8">
        <h2 class="text-xl font-semibold text-white mb-3">4. Cookies</h2>
        <p class="mb-2">Utilizamos dois tipos de cookies:</p>
        <ul class="list-disc pl-5 space-y-1">
            <li><strong class="text-white">Essenciais</strong> — necessários para autenticação e segurança da sessão. Não podem ser desactivados.</li>
            <li><strong class="text-white">Analíticos</strong> — recolhem dados de navegação de forma anónima para melhorar a plataforma. Apenas activados com o seu consentimento.</li>
        </ul>
        <p class="mt-2">Pode alterar as suas preferências a qualquer momento clicando em «Apenas essenciais» no banner de cookies.</p>
    </section>

    <section class="mb-8">
        <h2 class="text-xl font-semibold text-white mb-3">5. Partilha de dados</h2>
        <p>
    ...
    <section class="mb-8">
        <h2 class="text-xl font-semibold text-white mb-3">6. Transferências internacionais</h2>
        <p>
    ...
    <section class="mb-8">
        <h2 class="text-xl font-semibold text-white mb-3">7. Os seus direitos</h2>
    ...
    <section class="mb-8">
        <h2 class="text-xl font-semibold text-white mb-3">8. Conservação dos dados</h2>
        <p>
    ...
    <section>
        <h2 class="text-xl font-semibold text-white mb-3">9. Actualizações</h2>
        <p>
