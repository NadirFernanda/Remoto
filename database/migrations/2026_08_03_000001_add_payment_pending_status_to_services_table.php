...
{
    private const STATUSES_WITH = ['draft', 'published', 'accepted', 'in_progress', 'delivered', 'completed', 'cancelled', 'em_moderacao', 'negotiating', 'payment_pending'];
    private const STATUSES_WITHOUT = ['draft', 'published', 'accepted', 'in_progress', 'delivered', 'completed', 'cancelled', 'em_moderacao', 'negotiating'];
