...
class BriefingTemplateService
{
        ...
        return [
            ...
            'Gestão de redes sociais' => [
                ...
                'questions' => [
                    ...
                    'Vai responder comentários/mensagens ou quer que o freelancer cuide disso?',
                ],
                'example'  => 'Gestão completa do Instagram e Facebook de restaurante. 5 publicações/semana por rede, incluindo design e legenda. Precisamos de crescimento orgânico e interação com seguidores. Não temos estratégia definida — precisamos que o freelancer proponha.',
            ...
            'Edição de imagens e vídeos' => [
                ...
                'example'  => 'Edição de 4 vídeos por mês para canal YouTube de educação. Cada vídeo: 10-15 minutos, incluindo abertura animada, cortes, legendas e fundo musical. Temos o vídeo bruto gravado. Precisamos de entrega em 7 dias após receber o material.',
            ...
            'Consultoria em TI, negócios, finanças e RH' => [
                ...
                'example'  => 'Consultoria financeira para PME do sector de construção. Precisamos de análise de fluxo de caixa, re-estruturação de custos e projecções para 12 meses. Consultoria pontual com entrega de relatório detalhado em 2 semanas. Estimamos 20 horas de trabalho.',
    ...
    public static function generic(): array
    {
        return [
            ...
            'example'  => 'Preciso de um profissional para [descreva o projeto]. O objectivo é [resultado esperado]. O público-alvo é [descreva]. As principais entregas são: [liste]. Prazo: [data/período]. Referências: [links ou exemplos].',
