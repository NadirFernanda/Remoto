    ...
    public function getUrl(): string
    {
        ...
        try {
            return match($this->type) {
                ...
                'payment_released'     => route('freelancer.financial'),
                'saque_aprovado'       => route('freelancer.financial'),
                'saque_rejeitado'      => route('freelancer.financial'),
                ...
                'refund_processed'     => $this->target_role === 'freelancer' ? route('freelancer.financial') : route('client.refunds'),
                'refund_approved'      => $this->target_role === 'freelancer' ? route('freelancer.financial') : route('client.refunds'),
                'refund_rejected'      => $this->target_role === 'freelancer' ? route('freelancer.financial') : route('client.refunds'),
                ...
                'account_suspended'     => '#',
                'dispute_reminder'      => $sid ? route('service.dispute', $sid) : '#',
