...
class Profile extends Component
{
    ...
    {
        $this->validate([
            'profilePhoto' => 'required|image|mimes:jpeg,png,jpg,gif,webp|max:8192',
        ], [
            'profilePhoto.required' => 'Selecione uma imagem primeiro.',
    ...
    public function render()
    {
        return view('livewire.client.profile')
            ->layout('layouts.dashboard', ['dashboardTitle' => 'Meu Perfil']);
    }
}
