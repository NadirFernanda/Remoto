...
Route::middleware(['web', 'auth', 'role:admin', '2fa'])->group(function () {
    ...
    Route::get('/admin/carteira/usuario/{user}/movimentos', \App\Modules\Admin\Controllers\WalletHistoryController::class)
    ...
    // Admin — Relatórios (acessível a financeiro + relatorios)
    Route::get('/admin/relatorios/fluxo-caixa', \App\Livewire\Admin\CashFlow::class)->name('admin.reports.cashflow')->middleware('admin.module:relatorios');
    Route::get('/admin/relatorios/extrato-contabilidade', \App\Livewire\Admin\AccountingStatement::class)->name('admin.reports.accounting')->middleware('admin.module:relatorios');
    Route::get('/admin/relatorios/saques', \App\Livewire\Admin\WithdrawalReport::class)->name('admin.reports.withdrawals')->middleware('admin.module:relatorios');
    Route::get('/admin/relatorios/servicos', \App\Livewire\Admin\ServicesReport::class)->name('admin.reports.services')->middleware('admin.module:relatorios');
    ...
    Route::get('/admin/relatorios/financeiro/export', [FinancialExportController::class, 'exportCsv'])->name('admin.reports.financial.export')->middleware('admin.module:relatorios');
    ...
    Route::get('/admin/relatorios/fluxo-caixa/csv',   [ReportsExportController::class, 'cashFlowCsv'])->name('admin.reports.cashflow.csv')->middleware('admin.module:relatorios');
    Route::get('/admin/relatorios/fluxo-caixa/excel', [ReportsExportController::class, 'cashFlowExcel'])->name('admin.reports.cashflow.excel')->middleware('admin.module:relatorios');
    Route::get('/admin/relatorios/fluxo-caixa/pdf',   [ReportsExportController::class, 'cashFlowPdf'])->name('admin.reports.cashflow.pdf')->middleware('admin.module:relatorios');

    // Admin — Export: Extrato Contabilidade
    Route::get('/admin/relatorios/extrato-contabilidade/csv',   [ReportsExportController::class, 'accountingCsv'])->name('admin.reports.accounting.csv')->middleware('admin.module:relatorios');
    Route::get('/admin/relatorios/extrato-contabilidade/excel', [ReportsExportController::class, 'accountingExcel'])->name('admin.reports.accounting.excel')->middleware('admin.module:relatorios');
    Route::get('/admin/relatorios/extrato-contabilidade/pdf',   [ReportsExportController::class, 'accountingPdf'])->name('admin.reports.accounting.pdf')->middleware('admin.module:relatorios');
    ...
    Route::get('/admin/facturacao/excel', [ReportsExportController::class, 'genericBillingExcel'])->name('admin.facturacao.excel')->middleware('admin.module:relatorios');
