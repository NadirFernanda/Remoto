...
use App\Modules\Marketplace\Controllers\PortfolioMediaController;
...
Route::middleware('web')->group(function () {
    ...
    Route::get('/portfolio/{portfolio}/arquivo', [PortfolioMediaController::class, 'show'])->name('portfolio.media');
