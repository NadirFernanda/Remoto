...
/**
 * Rede de segurança para confirmar pagamentos AppyPay de patrocínio de
 * infoprodutos mesmo que o webhook falhe. Mesma lógica do
 * PollAppyPaySubscriptionCheckoutJob, mas para InfoprodutoPatrocinioCheckout.
 */
class PollAppyPayInfoprodutoPatrocinioCheckoutJob implements ShouldQueue
{
    ...
    public function handle(AppyPayGateway $gateway, AppyPayReconciliationService $reconciliation): void
    {
        ...
        if (!$charge['success']) {
            Log::warning('PollAppyPayInfoprodutoPatrocinioCheckoutJob: falha ao consultar estado', [
